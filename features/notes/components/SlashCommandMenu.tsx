...
export function SlashCommandMenu({
  ...
  return (
    <div className="mt-2 w-80 rounded-lg border border-zinc-700 bg-zinc-900 p-1 shadow-xl shadow-black/30">
      <p className="px-3 py-2 text-xs font-medium text-zinc-500">Insert blocks</p>
      <div className="grid gap-1">
        <button
          type="button"
          className="flex w-full items-center gap-3 rounded-md px-3 py-2 text-left text-sm text-zinc-100 hover:bg-zinc-800"
          onMouseDown={(event) => {
